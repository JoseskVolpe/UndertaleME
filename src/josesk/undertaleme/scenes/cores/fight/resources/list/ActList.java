...
public final class ActList extends List{
	
	private Monster monster;

	public ActList(Act[] list, Fight fightscene, Monster monster) throws EmptyListException {
	...
	protected void renderObject(Graphics g, boolean selected, Object object, int i, int x, int y) throws Error, Exception{
		...
		g.setColor(0xffffff);
		g.drawString("* "+act.getName(), x, y, Graphics.TOP|Graphics.LEFT);
