...
import josesk.undertaleme.scenes.cores.fight.resources.playerresources.Item;

public final class ItemList extends List{
	
	public ItemList(Item[] list, Fight fightscene) throws EmptyListException{
	...
	protected void renderObject(Graphics g, boolean selected, Object object, int i, int x, int y) throws Error, Exception{
		...
		g.setColor(0xffffff);
		g.drawString("* "+item.getName(), x, y, Graphics.TOP|Graphics.LEFT);
	...
	protected void selectObject(Object object, int index) throws Exception, Error {
		...
		fightscene.showMessageInformation(new Text(fightscene.getPlayer().getBackpack().useItem(item, fightscene, fightscene.getPlayer()), "Item_"+item.getName()), Fight.MODE_ITEMFINISH);
